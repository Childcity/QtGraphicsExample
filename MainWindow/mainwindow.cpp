    ...
    ui_(new Ui::MainWindow)
{
    ...
    setup2dRotatePoint();
    setupTransformationConrolPoints();
    update3dTransformation();
}
...
void MainWindow::update3dTransformation()
{
...
void MainWindow::connectAllSignalsSlots()
{
    {
        // Gasket conections
...

    {
        ...
        connect(ui_->spinBox_15, QOverload<int>::of(&QSpinBox::valueChanged), this, &MainWindow::update3dTransformation);
        connect(ui_->spinBox_16, QOverload<int>::of(&QSpinBox::valueChanged), this, &MainWindow::update3dTransformation);
        connect(ui_->spinBox_17, QOverload<int>::of(&QSpinBox::valueChanged), this, &MainWindow::update3dTransformation);
        connect(ui_->spinBox_17, QOverload<int>::of(&QSpinBox::valueChanged), this, &MainWindow::update3dTransformation);
        connect(ui_->checkBox_7, &QCheckBox::clicked, this, &MainWindow::update3dTransformation);
    }
...
void MainWindow::setupTransformationConrolPoints()
{
...
void MainWindow::setup2dRotatePoint()
{
